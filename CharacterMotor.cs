...
public class CharacterMotor : MonoBehaviour
{
    ...
    public class CharacterMotorMovement
    {
        ...
        public float maxSidewaysSpeed = 20.0f;
        public float maxBackwardsSpeed = 20.0f;
    ...
    private Vector3 ApplyInputVelocityChange(Vector3 velocity)
    {
        ...
        if (grounded && TooSteep())
        {
            ...
            desiredVelocity = inputMoveDirection;//new Vector3(groundNormal.x, 0, groundNormal.z).normalized;
                                                 // Find the input movement direction projected onto the sliding direction
                                                 //var projectedMoveDir = inputMoveDirection;//Vector3.Project(inputMoveDirection, desiredVelocity);
            ...
            desiredVelocity = inputMoveDirection;// GetDesiredHorizontalVelocity();
